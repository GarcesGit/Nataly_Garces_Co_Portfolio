                ...
                function (t, Xt, Jt) {
                    (function (t) {
                        ...
                        function At(r, a, l, c, t, e, u) {
                            var d;
                            if ((c && (d = e ? c(r, t, e, u) : c(r)), void 0 !== d))
                                return d;
                            if (!Vt(r)) return r;
                            var i,
                                n,
                        ...
                        (kt.prototype.clear = function () {
                            ...
                            (xt.prototype.delete = function (t) {
                                ...
                                return !(
                                    i < 0 ||
                                    (i == e.length - 1 ? e.pop() : lt.call(e, i, 1), 0)
                                );
                            }),
                    ...
                    (this.isMobile = document.documentElement.clientWidth < 768),
                        ...
                        this.isBasicScroll
                            ? (this.scrollContainer =
                                  document.querySelector(".basicScroll"))
...
window.addEventListener("load", function (e) {
    var _this = void 0,
        ...
        ultraMode = document.querySelector(".color-mode .night-mode"),
            ...
            _createClass(e, [
                {
                    ...
                    value: function (t) {
                        (this.documentBody = document.body),
                            ...
                            (this.stageContainer =
                                document.querySelector(".stageContainer")),
                            (this.stage = document.querySelector(".stage")),
                            (this.projectsLi = document.querySelectorAll(".projects li")),
                            (this.projectsLiA =
                                document.querySelectorAll(".projects li a")),
                            (this.isMobile = document.documentElement.clientWidth < 768),
                            (this.isSafari = !1),
                            ...
                            (this.projectsLiMouseOutRef =
                                this.projectsLiMouseOut.bind(this)),
                ...
                },
                {
                    ...
                    value: function () {
                        (this.stagePosition = this.lerp(
                            ...
                            (this.stagePosition =
                                Math.floor(1e4 * this.stagePosition) / 1e4);
                    ...
                    value: function () {
                        ...
                        (this.scrollOffset =
                            ...
                            (this.scrollPercent =
                                this.scrollOffset /
                                    (this.scrollHeight -
                                        this.documentBody.offsetHeight) || 0),
                            (this.scrollPercent *=
            ...
            _createClass(e, [
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        document.documentElement.clientWidth;
                        (this.scrollOffset =
                            this.post.pageYOffset || this.post.scrollTop),
                            (this.scrollPercent =
                                this.scrollOffset /
                                    (this.scrollHeight -
                                        this.documentBody.offsetHeight) || 0),
                            ...
                            (this.scrollPercent *=
                                -0.075 * this.documentBody.scrollWidth);
                    },
                },
            ]),
            e
            ...
            _createClass(e, [
                    ...
                    value: function (t) {
                        (this.documentBody = document.body),
                            ...
                            (this.journalContainer =
                                document.querySelector(".journal .container")),
                            (this.journalContent =
                ...
                },
                {
                    ...
                    value: function () {
                        this.isMobile ||
                            (window.removeEventListener("resize", this.resizeRef, !1),
                            this.journal.removeEventListener(
                                "scroll",
                                this.scrollRef,
                                !1
                            ));
                ...
                },
                {
                    ...
                    value: function () {
                        (this.scrollHeight = this.journalContent.offsetHeight),
                            (this.journalContainer.style.height =
            ...
            },
            {
                ...
                value: function () {
                    ...
                    (this.scrollOffset =
                        ...
                        (this.scrollPercent =
                            this.scrollOffset /
                                (this.scrollHeight - this.documentBody.offsetHeight) ||
                            0),
                        this.isMobile ||
                            (0.07 < this.scrollPercent &&
